    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtPhoneLogin.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                btnLogin.isEnabled = s.length == 10 && s.first().toString() == "0"
            }
        })
        ...
        btnLogin.setOnClickListener {
            ...
            if (phoneNumber.isNotBlank()) {
                ...
                mViewModel.loginWithPhoneNumber(this, phoneNumber.replaceFirst("0".toRegex(), "+66"))
        ...
        edtOTP.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                btnSubmit.isEnabled = s.isNotEmpty()
            }
        })
